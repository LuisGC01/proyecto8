...
import mx.unam.dgtic.diplomado.proyecto8.modelo.repository.IArregloMedicionRepository;
import mx.unam.dgtic.diplomado.proyecto8.modelo.repository.IDerivadaModeloMatematicoRepository;
import mx.unam.dgtic.diplomado.proyecto8.modelo.repository.IImagenRepository;
import mx.unam.dgtic.diplomado.proyecto8.modelo.repository.IMagnitudArregloRepository;
import mx.unam.dgtic.diplomado.proyecto8.modelo.repository.IMagnitudDetalleRepository;
import mx.unam.dgtic.diplomado.proyecto8.modelo.repository.IModeloMatematicoRepository;
...
public class ArregloServiceImpl implements IArregloService {
	...
	public ArregloMedicion insertarArreglo(ArregloMedicion entity) {
		...
		// Set<DerivadaModeloMatematico> derivadas = new
		// HashSet<DerivadaModeloMatematico>();
